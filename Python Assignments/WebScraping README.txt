...
My Code Basically Performs Four Main tasks:

First it fetches out the Webpage Content
Secondly it removes all the unwanted tags
Third, it formats the content in a readable way
Fourth, it prints out as a string or saves the output in a file
...
1) Comes the libraries or Modules:
                     ...
                     1.1) At First I used a bit of Libraries named lxml or Simply The HTML Parser and also the (CSS select) library
                          along with requests and re also, Although I got my desired output.
...
2) Making functions: 
                    ...
                    So basically 4 functions will be made
                  
                 2.1)
                      First function will be removing necessary CSS and JavaScript tags
                      which will scrap the webpage 
                2.2) 
                      Second function will be removing the unwanted tags found in the webpage
                      provided but keeping there content.
                2.3) 
                     Third Function will be regarding Cleaning and Formatting Lists.
                2.4)
                     Fourth Function will be regarding extracting and formatting content
                     inside the heading and paragraphs tags.
 ...
 3)Calling functions through assigning variables:
                              ...
                              COMBINING ALL 4 FUNCTIONS AND SAVING THE STATE
